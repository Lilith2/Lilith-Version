...
namespace eft_dma_radar.UI.Radar
{
    public sealed partial class MainForm : Form
    {
        ...
        private void SetControlTooltips()
        {
            ...
            toolTip1.SetToolTip(numericUpDown_AimLineLength, "Sets the Aimline Length for Local Player & Team");
            ...
            toolTip1.SetToolTip(numericUpDown_MaxDist,
    ...
    "Sets the lines scaling factor for the ESP Window.\nIf you are rendering at a really high resolution, you may want to increase this.");
        ...
        private void SetMemWriteFeatures()
        {
            ...
            comboBox_AimbotTarget.SelectedIndex = comboBox_AimbotTarget.FindStringExact(Aimbot.Config.Bone.GetDescription());
        ...
        protected override void OnFormClosing(FormClosingEventArgs e)
        {
            try
            {
                ...
                Config.Zoom = _zoom;
                Config.MaxDistance = (float)numericUpDown_MaxDist.Value;
